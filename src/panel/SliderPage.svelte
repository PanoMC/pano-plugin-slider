          ...
          <thead>
            <tr>
              ...
              <th scope="col" style="width: 150px;"
                >{$_("pages.slider.table.created-at")}</th
              >
              <th scope="col" style="width: 150px;"
                >{$_("pages.slider.table.updated-at")}</th
              >
            </tr>
          </thead>
    ...
    <div class="card-body">
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-6">
          <select
            class="form-control"
            id="renderHook"
            bind:value={settings.renderHook}
          >
            <option value="page:home:top"
              >{$_("pages.slider.settings.locations.home-top")}</option
            >
            <option value="page:top"
              >{$_("pages.slider.settings.locations.page-top")}</option
            >
          </select>
        </div>
      </div>
      ...
      <div class="row mb-3">
        <label class="col-md-6" for="autoSlide">
          ...
          <small class="d-block"
            >{$_("pages.slider.settings.fields.auto-slide-help")}</small
          >
        </label>
        <div class="col-md-6 d-flex align-items-center">
          <div class="form-check form-switch">
      ...
      <div class="row mb-3">
        <label class="col-md-6 col-form-label" for="interval">
          ...
          <small class="d-block"
            >{$_("pages.slider.settings.fields.interval-help")}</small
          >
        </label>
        <div class="col-md-6">
          <input
      ...
      <div class="row mb-3">
        <label class="col-md-6" for="fade">
          ...
          <small class="d-block"
            >{$_("pages.slider.settings.fields.fade-help")}</small
          >
        </label>
        <div class="col-md-6 d-flex align-items-center">
          <div class="form-check form-switch">
      ...
      <div class="row mb-3">
        <label class="col-md-6" for="indicators">
          ...
          <small class="d-block"
            >{$_("pages.slider.settings.fields.indicators-help")}</small
          >
        </label>
        <div class="col-md-6 d-flex align-items-center">
          <div class="form-check form-switch">
      ...
      <div class="row mb-3">
        <label class="col-md-6" for="controls">
          ...
          <small class="d-block"
            >{$_("pages.slider.settings.fields.controls-help")}</small
          >
        </label>
        <div class="col-md-6 d-flex align-items-center">
          <div class="form-check form-switch">
      ...
      <div class="row mb-3">
        <label class="col-md-6" for="wrap">
          ...
          <small class="d-block"
            >{$_("pages.slider.settings.fields.wrap-help")}</small
          >
        </label>
        <div class="col-md-6 d-flex align-items-center">
          <div class="form-check form-switch">
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-6">
          <select
            class="form-select"
            id="captionStyle"
            bind:value={settings.captionStyle}
          >
            <option value="none"
              >{$_("pages.slider.settings.fields.caption-style-none")}</option
            >
            <option value="solid"
              >{$_("pages.slider.settings.fields.caption-style-solid")}</option
            >
            <option value="glass"
              >{$_("pages.slider.settings.fields.caption-style-glass")}</option
            >
          </select>
        </div>
      </div>
